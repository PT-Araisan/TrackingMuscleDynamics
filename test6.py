...
# ROIの定義
roi1 = (286, 241, 50, 50)  # 第一のROI (x, y, 幅, 高さ)
roi2 = (286, 301, 50, 50)  # 第二のROI (x, y, 幅, 高さ) - 直下に配置
x1, y1, w1, h1 = roi1
x2, y2, w2, h2 = roi2
...
while True:
    ...
    # 計算結果を出力
    print(f" 第一のROIの動きの累積: {total_motion_magnitude1:.2f}")
    print(f" 第二のROIの動きの累積: {total_motion_magnitude2:.2f}")
...
# 動きの総合的な大きさを出力
print(f"全フレームの第一のROIの動きの総合的な大きさ: {total_motion_magnitude1:.2f}")
print(f"全フレームの第二のROIの動きの総合的な大きさ: {total_motion_magnitude2:.2f}")
